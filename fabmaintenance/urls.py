...
urlpatterns = [
    ...
    path('machines/<int:pk>/duplicate/', views.machine_duplicate, name='machine_duplicate'),
    ...
    path('maintenance/<int:maintenance_id>/validate/', views.validate_maintenance, name='validate_maintenance'),
] 